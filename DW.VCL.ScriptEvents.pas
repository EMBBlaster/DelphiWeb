...
type
  ...
  public
    constructor Create(Collection: TCollection; aEventType: TDWAsyncEventType); reintroduce;
...
constructor TDWScriptEvent.Create(Collection: TCollection; aEventType: TDWAsyncEventType);
begin
